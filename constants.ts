/**
 * Constants and configuration values for Vreko extension
 *
 * Threshold values are defined locally to maintain thin client architecture.
 * VSCode-specific constants are also defined here.
 */

import { THRESHOLDS } from "./constants/thresholds";

/** Default API base URL for Vreko services */
export const API_BASE_URL = "https://api.vreko.dev";

/** Pioneer dashboard URL - single source of truth for VS Code extension */
export const PIONEER_DASHBOARD_URL = "https://console.vreko.dev/dashboard";
