import type { ProtectionRule, VrekoRC, VrekoSettings } from "../types/vrekorc.types";
 ...
 */
export const DEFAULT_VREKO_CONFIG: Readonly<VrekoRC> = Object.freeze({
	...
	hooks: {},
	templates: [],
} as const satisfies VrekoRC);

/**
 * Default Vreko settings
 */
export const DEFAULT_SETTINGS: Readonly<VrekoSettings> = Object.freeze({
	maxSnapshots: 100,
	compressionEnabled: true,
	autoSnapshotInterval: 0,
	notificationDuration: 1000,
	...
	protectionDebounce: 1000,
	enableCaching: true,
} as const satisfies VrekoSettings);
