 ...
 *   // output:(context.userId);        // ✅ OK
 *   // output:(context.tier);          // ✅ OK
 *   // output:(context.anonymousId);   // ❌ Compile error
 * } else {
 *   // TypeScript narrows to AnonymousContext
 *   // output:(context.anonymousId);   // ✅ OK
 *   // output:(context.tier);          // ❌ Compile error
 * }
 * ```
 */
...
export const TIER_FEATURES = {
	...
	team: [
		// TODO: define team tier features post-launch
		"snapshots",
		"local-protection",
		"watch-mode",
		"ai-detection",
