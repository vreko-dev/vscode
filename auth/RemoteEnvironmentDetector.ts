 ...
 *
 * @see https://github.com/your-org/vreko/blob/main/apps/vscode/unified_ux_spec_UPDATED.md
 */
...
export class RemoteEnvironmentDetector {
	...
	detect(): RemoteEnvironmentInfo {
		...
		if (remoteName?.includes("ssh")) {
			...
			workarounds.push("Mount ~/.vreko as volume for persistence", "Use manual token authentication");
