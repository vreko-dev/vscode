...
/**
 * Context key names used by Vreko
 */
export const CONTEXT_KEYS = {
	/** User experience tier */
	EXPERIENCE_TIER: "vreko.experienceTier",

	/** Whether user is an explorer */
	IS_EXPLORER: "vreko.isExplorer",

	/** Whether user is intermediate */
	IS_INTERMEDIATE: "vreko.isIntermediate",

	/** Whether user is a power user */
	IS_POWER: "vreko.isPower",

	/** Whether AI checkpointing is enabled */
	AI_CHECKPOINTING_ENABLED: "vreko.aiCheckpointingEnabled",

	/** Whether any AI assistant is detected */
	AI_DETECTED: "vreko.aiDetected",

	/** Whether GitHub Copilot is detected */
	GITHUB_COPILOT_DETECTED: "vreko.githubCopilotDetected",

	/** Whether Claude is detected */
	CLAUDE_DETECTED: "vreko.claudeDetected",

	/** Whether Tabnine is detected */
	TABNINE_DETECTED: "vreko.tabnineDetected",

	/** Whether Codeium is detected */
	CODEIUM_DETECTED: "vreko.codeiumDetected",

	/** Whether extension is active */
	IS_ACTIVE: "vreko.isActive",

	/** Whether user has protected files */
	HAS_PROTECTED_FILES: "vreko.hasProtectedFiles",

	/** Whether user has snapshots */
	HAS_SNAPSHOTS: "vreko.hasSnapshots",

	/** Whether user has sessions */
	HAS_SESSIONS: "vreko.hasSessions",

	/** Whether user has policy overrides */
	HAS_POLICY_OVERRIDES: "vreko.hasPolicyOverrides",

	/** Whether offline mode is enabled */
	OFFLINE_MODE: "vreko.offlineMode",

	/** Whether telemetry is enabled */
	TELEMETRY_ENABLED: "vreko.telemetryEnabled",
} as const;
