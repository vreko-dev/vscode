 ...
 * @description CLI command execution utilities for running Vreko CLI commands via VS Code terminal
 *
...
/**
 * Execute "vreko init" command with optional flags
 */
...
/**
 * Execute "vreko protect" command with file paths
 */
