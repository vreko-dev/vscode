 ...
 * - MCP Agent Responses: `🦎 Vreko:` prefix
 ...
 * const prefix = BRANDING.agent.prefix; // 🦎 Vreko:
 * ```
 */
export const BRANDING = {
	...
	ui: {
		...
		// Activity (from VREKO_ICONS)
		aiEdit: VREKO_ICONS.EVENT_AI,
		manualSnapshot: VREKO_ICONS.EVENT_MANUAL,
		autoSnapshot: VREKO_ICONS.REFRESH,
		restoreAction: VREKO_ICONS.RESTORE,
		configChange: VREKO_ICONS.SETTINGS,
	...
	agent: {
		 ...
		 * // "🦎 Vreko: Checkpoint created before refactoring auth.ts"
		 */
	...
	heat: {
		...
		aiHot: `${VREKO_ICONS.AI_TOOL}${TEMPERATURE_LEVEL_SIGNAGE.hot.icon}`,
	},
