...
// Create a test config with proxy and symbol
const testConfig = `
...
module.exports = {
  ...
  proxyValue: proxy,
  // Object with symbol key should be rejected with ERR_NON_POJO_RETURN
  symbolObj: obj
};
`;

// Write test config to a temporary file
const testConfigPath = path.join(__dirname, "proxy-symbol-test-config.cjs");
