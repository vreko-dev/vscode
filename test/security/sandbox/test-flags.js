...
// Create a test config that tries to use eval directly (without require)
const testConfig = `
// This should fail with the --disallow-code-generation-from-strings flag
eval("1 + 1");
...
const testConfigPath = path.join(__dirname, "flag-test-config.cjs");
