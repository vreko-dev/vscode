...
/**
 * Vreko API client for fetching rules and policies
 */
export class VrekoAPI {
	private static instance: VrekoAPI;
	private baseUrl: string;
	private apiKey: string | null = null;

	private constructor() {
		// Default to production API
		this.baseUrl = "https://api.vreko.dev";
	...
	public static getInstance(): VrekoAPI {
		if (!VrekoAPI.instance) {
			VrekoAPI.instance = new VrekoAPI();
		}
		return VrekoAPI.instance;
	}
