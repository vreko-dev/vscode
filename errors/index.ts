/**
 * Comprehensive error type system for Vreko VS Code Extension
 *
...
// Import toError from local utilities to avoid @vreko/sdk runtime dependency
...
/**
 * Base error class for all Vreko errors
 *
 * Provides:
 ...
 */
export class VrekoError extends Error {
	constructor(
		message: string,
	...
	getFullMessage(): string {
		...
		while (current) {
			...
			current = current instanceof VrekoError ? current.cause : undefined;
		}
 ...
 */
export class StorageError extends VrekoError {
 ...
 */
export class SnapshotError extends VrekoError {
	constructor(message: string, code: string, cause?: Error) {
		super(message, code, cause);
 ...
 */
export class SessionError extends VrekoError {
	constructor(message: string, code: string, cause?: Error) {
		super(message, code, cause);
 ...
 */
export class ProtectionError extends VrekoError {
	constructor(message: string, code: string, cause?: Error) {
		super(message, code, cause);
 ...
 */
export class ValidationError extends VrekoError {
	constructor(
		message: string,
 ...
 */
export class ConfigurationError extends VrekoError {
	constructor(
		message: string,
 ...
 */
export class FileSystemError extends VrekoError {
	constructor(message: string, code: string, cause?: Error) {
		super(message, code, cause);
 ...
 */
export class EventBusError extends VrekoError {
	constructor(message: string, code: string, cause?: Error) {
		super(message, code, cause);
...
/**
 * Type guard to check if error is a VrekoError
 */
export function isVrekoError(error: unknown): error is VrekoError {
	return error instanceof VrekoError;
}
...
/**
 * Wraps error in VrekoError if not already one
 * Useful for ensuring all errors thrown are VrekoError instances
 */
export function ensureVrekoError(error: unknown, defaultCode = "UNKNOWN_ERROR"): VrekoError {
	if (isVrekoError(error)) {
		return error;
	}
	const errorObj = toError(error);
	return new VrekoError(errorObj.message, defaultCode, errorObj);
}
