...
export const REPO_STATUS_SIGNAGE: Readonly<Record<RepoStatusCanonical, RepoStatusSignage>> = {
	...
	error: {
		...
		tooltip: "Error: Vreko couldn't compute repo protection status. Check logs or try reloading.",
	},
} as const;
...
export const CORE_CONCEPT_SIGNAGE: Readonly<Record<CoreConceptKey, CoreConceptSignage>> = {
	...
	protectedFiles: {
		...
		icon: "🛡️",
		tooltip: "Files currently under Vreko protection.",
	},
	blockingIssues: {
		key: "blockingIssues",
	...
	watchItems: {
		...
		label: "Watch Items",
		icon: "📊",
		tooltip: "Non-blocking items Vreko is monitoring.",
	},
} as const;
