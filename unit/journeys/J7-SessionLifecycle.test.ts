...
// FIXME: This test file is incompatible with the current @vreko/auth API
// It references methods (generateWorkspaceId, startSession, endSession, etc.) that don't exist
// The original WorkspaceSessionManager.ts file was deleted; this test needs complete rewrite
// Original import: ../../../src/session/WorkspaceSessionManager
