...
vi.mock("../../../../src/telemetry/ActivationFunnelIntegration.js", () => ({
...
vi.mock("../../../../src/services/daemon-bridge/index.js", async (importOriginal) => {
...
describe("DaemonBridge  -  race condition guard (spec 1.3)", () => {
	describe("getDaemonBridge registry", () => {
		it("returns the same bridge instance for the same workspaceId", async () => {
			const { getDaemonBridge } = await import("../../../../src/services/DaemonBridge.js");
