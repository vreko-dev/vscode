 ...
 * that bridges @vreko/intelligence to VS Code extension.
 *
...
// Mock @vreko/intelligence
vi.mock("@vreko/intelligence", () => ({
...
import { Intelligence } from "@vreko/intelligence";
...
describe("IntelligenceService", () => {
	...
	describe("happy path - core", () => {
		it("should get Intelligence instance for workspace", async () => {
			...
			expect(Intelligence).toHaveBeenCalledWith(expect.objectContaining({ rootDir: expect.stringContaining(".vreko") }));
		});
	...
	describe("configuration", () => {
		it("should use .vreko directory in workspace", async () => {
			await getIntelligence();
			expect(Intelligence).toHaveBeenCalledWith(expect.objectContaining({ rootDir: "/test/workspace/.vreko" }));
		});
