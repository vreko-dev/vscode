 ...
 *
 * Tests the bridge between VS Code extension and @vreko/intelligence CommitRiskSystem.
...
describe("CommitRiskBridge", () => {
	...
	describe("Persistence", () => {
		...
		it("should restore from persisted workspace state", async () => {
			...
			await mockMemento.update("vreko.commitRisk.state", persistedState);
