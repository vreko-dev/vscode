...
describe("PRWManager", () => {
	...
	let PRWManager: typeof import("../../../src/services/PRWManager").PRWManager;
	let createPRWManager: typeof import("../../../src/services/PRWManager").createPRWManager;
	...
	beforeEach(async () => {
		...
		const module = await import("../../../src/services/PRWManager");
