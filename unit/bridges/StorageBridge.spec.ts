...
import { Storage as V2Storage, type SnapshotManifest as V2Manifest } from "@vreko/engine";
import type { VrekoEventBus } from "@vreko/contracts";
...
describe("StorageBridge", () => {
	...
	let mockEventBus: VrekoEventBus;
