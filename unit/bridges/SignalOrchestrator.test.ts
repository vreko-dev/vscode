...
const mockCalculateComplexityAggregate = vi.mocked(
	(await import("@vreko/engine/signals")).calculateComplexityAggregate
);
const mockCalculateRiskScore = vi.mocked(
	(await import("@vreko/engine/signals")).calculateRiskScore
);
const mockIsSensitiveFile = vi.mocked(
	(await import("@vreko/engine/signals")).isSensitiveFile
);
