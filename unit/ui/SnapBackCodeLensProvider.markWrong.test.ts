/**
 * VrekoCodeLensProvider MarkWrong Tests
 *
...
import { VrekoCodeLensProvider } from "../../../src/ui/VrekoCodeLensProvider";
...
type VrekoCodeLensProviderWithDeps = new (
	protectedFileRegistry: ProtectedFileRegistry,
	falsePositiveTracker?: IFalsePositiveTracker,
	telemetryProxy?: TelemetryProxy,
) => VrekoCodeLensProvider;

describe("VrekoCodeLensProvider MarkWrong", () => {
	let provider: VrekoCodeLensProvider;
	...
	describe("HAPPY PATH: Mark Wrong functionality", () => {
		it("should record false positive when handleMarkWrong is called", async () => {
			// Arrange
			provider = new (VrekoCodeLensProvider as unknown as VrekoCodeLensProviderWithDeps)(
