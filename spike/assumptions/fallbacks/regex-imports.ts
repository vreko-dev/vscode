...
export async function getBasicImportGraph(workspace: string): Promise<Record<string, string[]>> {
...
function extractImports(content: string, filePath: string, workspace: string): string[] {
...
function resolveImport(importPath: string, fromFile: string, workspace: string): string | null {
