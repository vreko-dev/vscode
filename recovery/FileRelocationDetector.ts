 ...
 *
 * @see https://github.com/your-org/vreko/blob/main/apps/vscode/unified_ux_spec.md
 */
...
export class FileRelocationDetector {
	 ...
	 */
	private classifyRelocation(originalPath: string, newPath: string): "renamed" | "moved" | "moved_and_renamed" {
	 ...
	 */
	async promptForRelocationChoice(relocations: RelocationCandidate[]): Promise<RelocationChoice[] | null> {
	 ...
	 */
	private async promptPerFileChoice(relocations: RelocationCandidate[]): Promise<RelocationChoice[]> {
