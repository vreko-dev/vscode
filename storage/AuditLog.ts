...
/**
 * AuditLog - Append-only audit logging
 *
 * Provides JSONL-format audit logging for tracking snapshot and protection events.
 * Delegates to the CLI daemon via DaemonBridge for storage operations.
 *
 * @see DaemonBridge for the daemon RPC protocol
 */

import { generateAuditId } from "@vreko/contracts";
