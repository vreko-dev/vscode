...
// Re-export creation option types and metadata type from snapshot-types (neutral file, no cycles)
import type { SnapshotCheckpointMetadata } from "./snapshot-types";

export type { CreatePOSTOptions, CreatePREOptions, SnapshotCheckpointMetadata } from "./snapshot-types";
