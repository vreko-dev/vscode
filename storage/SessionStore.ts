...
/**
 * SessionStore - Session manifest storage
 *
 * Manages session manifests for grouping related snapshots.
 * Delegates to the CLI daemon via DaemonBridge for storage operations.
 *
 * @see DaemonBridge for the daemon RPC protocol
 */

import { generateSessionId, parseIdTimestamp as parseTimestampFromId } from "@vreko/contracts";
