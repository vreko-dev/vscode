 ...
 *
 * Manages protection levels and engine settings with VS Code workspace state.
 * Delegates to the CLI daemon via DaemonBridge for cross-platform persistence.
 *
 ...
 *
 * STORAGE LOCATION:
 * - ~/.config/Code/User/globalStorage/vreko.id/config.json
 *
 * SCHEMA:
 * {
 *   version: 1,
