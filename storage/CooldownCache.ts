...
/**
 * CooldownCache - In-memory cooldown tracking
 *
 * Provides automatic expiration for cooldown entries to prevent
 * rapid repeated operations on the same file.
 * Delegates to the CLI daemon via DaemonBridge for persistence.
 *
