...
export class AccountDeletionHandler {
	...
	private readonly POINTS_KEY = "vreko.pioneer.points";
	private readonly SNAPSHOTS_KEY = "vreko.snapshots";
	private readonly AUTH_KEY = "vreko.auth";
	private readonly SETTINGS_KEY = "vreko.settings";
	...
	async handleRejoin(_newUserId: string): Promise<{
		...
		return {
			success: true,
			isCleanSlate: true,
			message: hasResidualData ? "Previous account data cleared." : "Welcome to 🦎 Vreko!",
		};
	}
}
