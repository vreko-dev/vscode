 ...
 * Sources:
 * - OnboardingProgression (vreko:onboarding-state)
 * - MilestoneService (vreko.milestones.*, vreko.events.*)
...
export const STORAGE_KEYS = {
	// New unified key
	UNIFIED: "vreko.onboarding.unified",

	// Legacy OnboardingProgression
	LEGACY_PROGRESSION: "vreko:onboarding-state",

	// Legacy MilestoneService
	SNAPSHOT_COUNT: "vreko.milestones.snapshotCount",
	TOTAL_FILES_PROTECTED: "vreko.milestones.totalFilesProtected",
	TOTAL_RECOVERIES: "vreko.milestones.totalRecoveries",
	FIRST_SNAPSHOT_CREATED: "vreko.events.first_snapshot_created",

	// Legacy scattered flags
	MCP_CONFIGURED: "mcp.configured",
	HAS_AUTHENTICATED: "vreko.hasAuthenticated",
	WELCOME_SHOWN: "vreko.progressiveDisclosure.welcomeShown",
} as const;
