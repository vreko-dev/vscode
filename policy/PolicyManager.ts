...
/**
 * PolicyManager handles loading and applying policies from .vreko/policy.json
 *
 * This manager loads policies from the .vreko/policy.json file and provides
 ...
 * that are diff-reviewable and stored in the .vreko directory.
 */
export class PolicyManager {
	...
	constructor(private workspaceRoot: string) {
		this.policyPath = path.join(workspaceRoot, ".vreko", "policy.json");
	}
	...
	/**
	 * Load policy from .vreko/policy.json
	 */
	...
	private async createDefaultPolicy(): Promise<void> {
		try {
			...
			const vrekoDir = path.dirname(this.policyPath);
