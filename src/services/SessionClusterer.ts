...
// ============================================================================
// DBSCAN Implementation (inlined from @snapback/core/clustering)
// ============================================================================
 ...
 * console.log(`Latest session: ${latestSession.label}`);
 * console.log(`Contains ${latestSession.snapshots.length} snapshots`);
 * ```
 */
