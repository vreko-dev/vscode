...
const STORAGE_KEYS = {
	FINGERPRINT: "snapback.attribution.fingerprint",
	SOURCE: "snapback.attribution.source",
	UTM_PARAMS: "snapback.attribution.utmParams",
	REFERRAL_CODE: "snapback.attribution.referralCode",
	TRANSFERRED: "snapback.attribution.transferred",
};
...
export class AttributionClient {
	...
	private apiClient: ApiClientORPC;
	 ...
	 * typically via a deeplink like: vscode://snapback.snapback/attribution?...
	 *
