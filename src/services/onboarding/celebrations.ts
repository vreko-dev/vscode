...
/**
 * SnapBack branding constants - re-exported from signage for consistency
 * Use BRAND_SIGNAGE.logo and BRAND_SIGNAGE.shortLabel for consistent branding
 */
export const SNAPBACK_ICON = BRAND_SIGNAGE.logo;
export const SNAPBACK_PREFIX = `${BRAND_SIGNAGE.logo} ${BRAND_SIGNAGE.shortLabel}:`;
