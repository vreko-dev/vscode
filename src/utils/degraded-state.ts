...
class DegradedStateManager {
	...
	private getDefaultSuggestion(component: DegradedComponent, _reason: string): string {
		const suggestions: Record<DegradedComponent, string> = {
			daemon: "Try restarting the SnapBack daemon with 'SnapBack: Restart Daemon'",
			storage: "Check disk space and file permissions in .snapback/ directory",
			...
			snapshot_service: "Try running 'SnapBack: Clear Cache' and creating a new snapshot",
