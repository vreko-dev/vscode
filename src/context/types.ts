/**
 * SnapBack Context File Types
 *
 * Defines the structure of .snapback/ctx/context.json - the intelligence layer
...
/**
 * Main context structure written to .snapback/ctx/context.json
 */
export interface SnapBackContext {
