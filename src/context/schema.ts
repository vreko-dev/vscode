/**
 * JSON Schema for SnapBack Context File
 *
 * Provides IDE intellisense for .snapback/ctx/context.json
 *
 * 🧢 SnapBack
 */
...
export const CONTEXT_SCHEMA = `{
  ...
  "$id": "https://snapback.dev/schemas/context.json",
  "title": "SnapBack Context",
